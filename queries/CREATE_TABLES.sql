...
--
-- Run this once against an empty SQLite database, then import each CSV
-- in data/ into its matching table. Import route_requirements first.
--
-- Types are declared explicitly rather than letting an import wizard
-- infer them: a wizard creates every column as TEXT, which turns
-- base_steps * 8 into string concatenation instead of arithmetic.
-- =====================================================================
...
-- alt_applies records whether a room's alt_condition actually holds on
-- this route, so queries don't have to interpret the condition text:
...
-- room_id is nullable: not every such encounter happens in a room that
-- appears in `rooms`.
-- ---------------------------------------------------------------------
...
-- =====================================================================
-- Verification — run after importing.
-- =====================================================================
